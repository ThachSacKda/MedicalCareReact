...
saveDetailDoctorService, getAllSpecialty} from '../../services/userService';
...
export const getRequiredDoctorInfor = () => {
    ...
    return async (dispatch, getState) => {
        try {
            dispatch({type: actionTypes.FETCH_RIQUIRED_DOCTOR_INFOR_START})
...
export const fetchRequireDoctorInforSuccess = (allRequiredData) => ({
    type: actionTypes.FETCH_RIQUIRED_DOCTOR_INFOR_SUCCESS,
    data: allRequiredData
})

export const fetchRequireDoctorInforFailed = () => ({
    type: actionTypes.FETCH_RIQUIRED_DOCTOR_INFOR_FAILED
})
